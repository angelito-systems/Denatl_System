...
<script lang="ts">
    ...
    import { Save, Search, UserRoundPen } from 'lucide-svelte';
...
<AppHead title="Editar Paciente" />

<div class="flex flex-1 flex-col gap-6 p-6 max-w-4xl mx-auto w-full">
    <div class="flex items-center gap-2">
        <UserRoundPen class="h-8 w-8 text-blue-600" />
        <div>
            <h1 class="text-3xl font-bold tracking-tight">Editar Paciente</h1>
            <p class="text-muted-foreground">Actualiza los datos personales del paciente.</p>
        </div>
    </div>
